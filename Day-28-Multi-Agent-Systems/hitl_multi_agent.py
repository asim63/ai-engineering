...
research = state.values['research_results']
print("\n" + "="*50)
print("RESEARCH FINDINGS (review before writing)")
print("="*50)
print(research)
print("="*50)

approval = input("\nApprove this research and proceed to writing? (yes/no): ").strip().lower()

if approval == "yes":
    # Resume — writer node runs now
    ...
    with open(r"D:\Projects\ai-engineering\Day-28-Multi-Agent-Systems\final_article.md", "w", encoding="utf-8") as f:
        f.write(result["final_article"])
    print("\nArticle saved.")
else:
    print("Writing cancelled. Research saved in state if you want to resume later.")